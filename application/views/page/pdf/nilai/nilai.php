...
$table .=   '<tr>
                ...
                <th style="border: 1px solid grey; width: 420px;">Kemampuan</th>
                <th style="border: 1px solid grey; width: 40px;">MB</th>
                <th style="border: 1px solid grey; width: 40px;">BB</th>
                <th style="border: 1px solid grey; width: 40px;">BSH</th>
                <th style="border: 1px solid grey; width: 40px;">BSB</th>
            </tr>';
$no = 1;
foreach ($aspekpengembangan as $a) {
    $table .= '<tr>
                    <td style="border: 1px solid grey; width: 40px;">' . $no++ . '</td>
                    <td style="border: 1px solid grey; width: 420px;">' . $a->kemampuan . '</td>
                    <td style="border: 1px solid grey; width: 40px">' . $a->mb . '</td>
                    <td style="border: 1px solid grey; width: 40px;">' . $a->bb . '</td>
                    <td style="border: 1px solid grey; width: 40px;">' . $a->bsh . '</td>
                    <td style="border: 1px solid grey; width: 40px;">' . $a->bsb . '</td>
                </tr>';
}
$table .= '</table>';
